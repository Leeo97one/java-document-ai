...
## [3.0.0](https://github.com/googleapis/java-document-ai/compare/v2.6.2...v3.0.0) (2022-09-15)


### ⚠ BREAKING CHANGES

* Added Processor Management and Processor Version support to v1 library
* Added Processor Management and Processor Version support to v1 library
...
* Added field_mask to ProcessRequest object in document_processor_service.proto ([#868](https://github.com/googleapis/java-document-ai/issues/868)) ([a4a1ecf](https://github.com/googleapis/java-document-ai/commit/a4a1ecfd7f310358176dc506d76622a5ab33720f))
...
* fix minor docstring formatting ([a4a1ecf](https://github.com/googleapis/java-document-ai/commit/a4a1ecfd7f310358176dc506d76622a5ab33720f))
